...
This file is adapted from https://github.com/bioinf-jku/TTUR/blob/master/fid.py
'''
...
def get_activations_from_files(files, sess, batch_size=50, verbose=True):
    ...
    for i in range(n_batches):
        ...
        pred_arr[start:end] = pred.reshape(min(batch_size, end-start),-1)
...
if __name__ == "__main__":
    ...
    fid_value = calculate_fid_given_paths(args.path, args.inception, low_profile=True)
    print("FID: ", fid_value)
