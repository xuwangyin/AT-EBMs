...
python prepare_datasets/resize_crop.py --resize 256 --datadir prepare_datasets/downloads/afhq_v2/train/cat --savedir datasets/AFHQ-png/afhq256/train/cat/data
